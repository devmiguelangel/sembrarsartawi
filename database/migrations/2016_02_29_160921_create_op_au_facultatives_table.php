...
class CreateOpAuFacultativesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('op_au_facultatives', function (Blueprint $table) {
            $table->integer('id')->unsigned();
            $table->integer('op_au_detail_id')->unsigned();
            ...
            $table->primary('id');
            $table->foreign('op_au_detail_id')->references('id')->on('op_au_details');
    ...
    {
        Schema::drop('op_au_facultatives');
    }
}
