...
class CreateOpAuObservationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('op_au_observations', function (Blueprint $table) {
            $table->integer('id')->unsigned();
            $table->integer('op_au_facultative_id')->unsigned();
            ...
            $table->primary('id');
            $table->foreign('op_au_facultative_id')->references('id')->on('op_au_facultatives');
    ...
    {
        Schema::drop('op_au_observations');
    }
}
