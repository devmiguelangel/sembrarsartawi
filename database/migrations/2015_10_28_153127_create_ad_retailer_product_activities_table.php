...
class CreateAdRetailerProductActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ad_retailer_product_activities', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('ad_retailer_product_activities');
    }
}
