...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(array('route' => 'create_category', 'name' => 'CreateForm', 'id' => 'CreateForm', 'method'=>'post', 'class'=>'form-horizontal')) !!}
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2">Categoria: <span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('admin.au.increment.list', ['nav'=>'au_increment', 'action'=>'list', 'id_retailer_product'=>$id_retailer_product])}}" class="btn btn-primary">
                        Cancelar <i class="icon-arrow-right14 position-right"></i>
                    </a>
                    <input type="hidden" name="id_retailer_products" value="{{$id_retailer_product}}">
                </div>
            {!!Form::close()!!}
        </div>
    </div>
