    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="form-wizard-title text-semibold" style="border-bottom: 0px;">
                ...
                Formulario Producto Automotores
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'update_au_parameter_additional', 'name' => 'UpdateForm', 'id' => 'UpdateForm', 'method'=>'post', 'class'=>'form-horizontal')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-2">Cantidad de Autos <span class="text-danger">*</span></label>
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-2">Antigüedad del vehiculo <span class="text-danger">*</span></label>
                    <div class="col-lg-10">
                        <input type="text" name="antiguedad" id="antiguedad" class="form-control required number" value="{{$query->old_car}}" maxlength="2" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="text-right">
                ...
                <a href="{{route('admin.au.parameters.list-parameter-additional', ['nav'=>'au_parameter', 'action'=>'list_parameter_additional', 'id_retailer_product'=>$id_retailer_product])}}" class="btn btn-primary">
