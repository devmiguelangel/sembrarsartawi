...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'create_au_parameter', 'name' => 'CreateForm', 'id' => 'CreateForm', 'method'=>'post', 'class'=>'form-horizontal')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="antiguedad" id="antiguedad" class="form-control required number" maxlength="2" autocomplete="off">
                    </div>
                </div>
