...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'update_content_au', 'name' => 'UpdateForm', 'id' => 'UpdateForm', 'method'=>'post', 'class'=>'form-horizontal', 'files' => true)) !!}
            ...
            <div class="text-right">
                ...
                <a href="{{ route('admin.au.content.list', ['nav'=>'au_content', 'action'=>'list', 'id_retailer_product'=>$id_retailer_product]) }}" class="btn btn-primary">
