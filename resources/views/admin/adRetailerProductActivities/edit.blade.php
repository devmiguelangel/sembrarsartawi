            ...
            {!! Form::open(array('route' => ['update_ad_retailer_product_activities','id'=>$adRetailerProductId], 'name' => 'Form', 'id' => 'ad_retailer_product_activities', 'method'=>'post', 'class'=>'form-horizontal form-validate-jquery')) !!}
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <select class="form-control" multiple="multiple" id="adActivities" name="adActivities[]" required="required" data-popup="tooltip" title="Presione la tecla [Ctrl] para seleccionar mas opciones o presione la tecla [shift] para seleccionar todas las opciones">
