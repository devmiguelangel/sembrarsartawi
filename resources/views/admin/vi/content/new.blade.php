...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'create_content_vi', 'name' => 'CreateForm', 'id' => 'CreateForm', 'method'=>'post', 'class'=>'form-horizontal', 'files' => true)) !!}
            ...
            <div class="text-right">
                ...
                <a href="{{ route('admin.vi.content.list', ['nav'=>'contentvi', 'action'=>'list', 'id_retailer_product'=>$id_retailer_product]) }}" class="btn btn-primary">
