...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'update_plans_vi', 'name' => 'UpdateForm', 'id' => 'UpdateForm', 'method'=>'post', 'class'=>'form-horizontal')) !!}
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control required text" name="txtName" id="txtName" value="{{$query->name}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="1" cols="5" class="form-control summernote" name="txtDesc" id="txtDesc">{{$query->description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control required number" name="txtPrimaM" id="txtPrimaM" value="{{$query->monthly_premium}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control required number" name="txtPrimaA" id="txtPrimaA" value="{{$query->annual_premium}}">
                        </div>
                    </div>
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        @var $plan = json_decode($query->plan, true);
                        <div class="col-lg-10">
                            <div class="row">
                                <div class="col-md-12">
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                        <tr>
                                            <td>
                                                <div class="form-group has-feedback">
                                                    <textarea rows="1" cols="19" class="form-control required" name="txtOp1" id="txtOp1">{{$plan[0]['cov']}}</textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control input-sm required number" name="txtBs1" id="txtBs1" placeholder="Bs." value="{{$plan[0]['rank']}}">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group has-feedback">
                                                    <textarea rows="1" cols="19" class="form-control required" name="txtOp2" id="txtOp2">{{$plan[1]['cov']}}</textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control input-sm required number" name="txtBs2" id="txtBs2" placeholder="Bs." value="{{$plan[1]['rank']}}">
                                                    <div class="form-control-feedback">
                                                        <i class="icon-cash3"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group has-feedback">
                                                    <textarea rows="1" cols="19" class="form-control required" name="txtOp3" id="txtOp3">{{$plan[2]['cov']}}</textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control input-sm required number" name="txtBs3" id="txtBs3" placeholder="Bs." value="{{$plan[2]['rank']}}">
                                                    <div class="form-control-feedback">
                                                        <i class="icon-cash3"></i>
                                                    </div>
                                                </div>
                ...
                <div class="text-right">
                    ...
                    <input type="hidden" name="id_planes" value="{{$id_planes}}">
