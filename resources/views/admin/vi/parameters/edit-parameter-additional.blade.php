...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'update_parameter_aditional_vi', 'name' => 'UpdateForm', 'id' => 'UpdateForm', 'method'=>'post', 'class'=>'form-horizontal')) !!}
            <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="monto_min" id="monto_min" class="form-control required number" autocomplete="off" value="{{$query->amount_min}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="monto_max" id="monto_max" class="form-control required number" autocomplete="off" value="{{$query->amount_max}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="num_titu" id="num_titu" class="form-control required number" autocomplete="off" value="{{$query->detail}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="caduc" id="caduc" class="form-control required number" autocomplete="off" value="{{$query->expiration}}">
                    </div>
                </div>
            ...
            <div class="text-right">
                ...
                <input type="hidden" name="id_product_parameters" value="{{$id_product_parameters}}">
            </div>
            {!!Form::close()!!}
        </div>
    </div>
