...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            {!! Form::open(array('route' => 'create_new_email', 'name' => 'NewForm', 'id' => 'NewForm', 'method'=>'post', 'class'=>'form-horizontal')) !!}
                <fieldset class="content-group">

                    <div class="form-group">
                        <label class="control-label col-lg-2">Nombre completo <span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <input type="text" name="txtNombre" id="txtNombre" class="form-control required text" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="txtEmail" id="txtEmail" class="form-control required email" autocomplete="off">
                        </div>
                    </div>
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('admin.email.new-add-email', ['nav'=>'email', 'action'=>'new_add_email'])}}" class="btn btn-primary">
