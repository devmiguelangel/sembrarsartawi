                ...
                <td class="text-center">
                    <ul class="icons-list">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="#"><i class="icon-file-pdf"></i> Editar</a></li>
                                <li><a href="#"><i class="icon-file-excel"></i> Cambiar contraseña</a></li>
                                <li><a href="#"><i class="icon-file-word"></i> Resetear contraseña</a></li>
                                <li><a href="#"><i class="icon-file-empty"></i>Dar baja</a></li>
                            </ul>
                        </li>
                    </ul>
