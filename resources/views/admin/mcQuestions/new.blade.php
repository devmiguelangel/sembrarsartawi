...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        {!! Form::open(array('route' => 'create_mc_questions', 'name' => 'Form', 'id' => 'mc_questions', 'method'=>'post', 'class'=>'form-horizontal form-validate-jquery')) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        <input type="text" placeholder="Pregunta" class="form-control" name="question" id="question" required="required">
                    </div>
                </div>
            </div>
            <div class="form-group">
