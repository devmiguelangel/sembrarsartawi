            ...
            {!! Form::open(['route' => ['de.fa.store.answer', 'rp_id' => $rp_id, 'id' => encode($fa->id), 'id_observation' => $id_observation ], 
                ...
                <div class="form-group animated">
                    <div class="col-lg-12">
                        ...
                        <label id="location-error" class="validation-error-label" for="location" ng-show="errors.observation_response">
                ...
                <div class="text-right">
                    <script ng-if="success.facultative">
                        $(function(){messageAction('succes', 'La respuesta fué procesada correctamente.');});
                    </script>
