@foreach($query_car as $data_car)
    <div style="width: 775px; height: auto; border: 0px solid #0081C2; padding: 5px;">
        <div style="width: 774px; font-weight: normal; font-size: 12px; font-family: Arial, Helvetica, sans-serif; color: #000000; border: 0px solid #FFFF00;">
            ...
            <span style="font-weight:bold; font-size:65%; font-family: Arial;">3. Categoría de vehículos: {{$data_car->category=='CA'?'A':'B'}}</span>
