                ...
                @if($query_header->issued == 1 && $query_header->canceled == 0)
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: auto; font-size: 67%; font-family: Arial; margin-bottom: 20px;">
                        ...
                        @foreach($query_details as $data_cl)
                            @var $border_bottom = ''
                            @if($ti==2)
                                @var $border_bottom = 'border-bottom:1px solid #080808;'
                            @endif
                            <tr>
                                <td style="width: 20%; border-top: 1px solid #080808; border-left: 1px solid #080808;">TITULAR {{$ti}}.</td>
                                ...
                                @if($key==$data_cl->id_details)
                                    @foreach($values as $index=>$items)
                                        <tr>
                                            ...
                                            <td align="center" style="width: 20%; border-top: 1px solid #080808; {{$border_bottom}}
                                            border-left: 1px solid #080808; border-right: 1px solid #080808;">
