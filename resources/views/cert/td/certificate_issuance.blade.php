<div style="width: 775px; height: auto; border: 0px solid #0081C2; padding: 5px;">
    <div style="width: 770px; font-weight: normal; font-size: 12px; font-family: Arial, Helvetica, sans-serif; color: #000000; border: 0px solid #FFFF00;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: auto; font-family: Arial; font-size: 58%;">
            <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: auto; font-size: 60%; font-family: Arial;">
            <tr>
                ...
                <td style="width:98%;">
                    ...
                    (SIEMPRE Y CUANDO ESTÉN INCLUIDAS EN EL AVALÚO TÉCNICO), REVESTIMIENTOS; VIDRIOS, ACCESORIOS SANITARIOS,                MUROS PERIMETRALES, TANQUES; ESTACIONAMIENTOS, ÁREAS DE DEPÓSITO Y LA PARTE PROPORCIONAL DE ÁREAS COMUNES,                CUANDO CORRESPONDA.
                </td>
            </tr>
            <tr>
                <td style="width:2%;" valign="top">&bull;</td>
                <td style="width:98%;">
                    INCLUYENDO INMUEBLES DOMICILIARIOS, COMERCIALES, O INMUEBLES INDUSTRIALES (ESTOS ÚLTIMOS PREVIA AUTORIZACIÓN
                    DE LA COMPAÑÍA). SE ACLARA QUE EL VALOR ASEGURADO MÁXIMO PARA RIESGOS INDUSTRIALES ES DE HASTA USD 200.000 POR
                    BIEN DECLARADO.
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td style="width:80%; text-align:justify; border-bottom: 1px solid #000; padding: 5px 3px;">
                    @foreach($query_riesgo as $data_riesgo)
                        ...
                        <b>{{$matter_insured}}:</b> {{$data_riesgo->matter_description}}, <b>Nro:</b> {{$data_riesgo->number}},
                        @if($data_riesgo->matter_insured=='PR')
                            <b>Uso:</b> {{$parameter_use[$data_riesgo->use]}} terminado Valorado en: {{$data_riesgo->insured_value}}<br>
                        @else
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: auto; font-size: 65%; font-family: Arial;">
            <tr>
                <td style="width:50%; text-align: justify; padding:5px; border:0px solid #333;" valign="top">
                    ...
                    Valor  de reposición a nuevo del inmueble (Valor de la construcción), según el avalúo técnico (en poder del contratante / beneficiario)
        ...
        @if((boolean)$query_header->facultative === true)
            @if((boolean)$query_header->approved === true)
                ...
                <div style="font-size:6pt; text-align:center; margin-top:5px; margin-bottom:0px; border:1px solid #C68A8A; background:#FFEBEA; padding:8px; width:98%;" align="left">
                    APROBADO POR LA COMPAÑÍA ASEGURADORA DE ACUERDO A LAS SIGUIENTES CONDICIONES, MISMAS QUE PREVALECERÁN SOBRE LAS ANTERIORES
                </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: auto; font-size: 65%; font-family: Arial; margin-bottom: 4px;">
                    <tr>
                        <td style="width:50%; text-align: justify; padding:5px; border:0px solid #333;" valign="top">
                            ...
                            Todo riesgo de daños a la propiedad,  incluyendo terremoto, erupción volcanica, temblor y/o movimientos
                            sísmicos al igual que el incendio resultante de estos, deslizamientos, asentamientos no graduales,
                        ...
                        <td style="width:50%; text-align: justify; padding:5px; border:0px solid #333;" valign="top">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                ...
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                                    <td style="width:98%;">Para robo con violencia al contenido: USD 100.- (aplicable únicamente a
                                        riesgos domiciliarios); para otros riesgos:   USD 250 por toda y cada pérdida</td>
                                </tr>
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                                ...
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                                    <td style="width:98%;">Para las coberturas de asentamiento, hundimiento, deslizamiento, corrimiento de tierras, 5% del valor del reclamo con un mínimo de USD. 500.- por toda y cada pérdida</td>
                                </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                ...
                                <tr>
                                    <td style="width:2%;" valign="top">&bull;</td>
                                    <td style="width:98%;">Demás equipos 2% del valor del siniestro mínimo USD. 250.-</td>
                                </tr>
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                                ...
                                <tr>
                                    ...
                                    <td style="width:98%;">Equipos móviles y/o portátiles: 2% del valor del reclamo con un mínimo de
                                        USD. 250 por evento y/o reclamo.</td>
                                </tr>
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                                    <td style="width:98%;">Demás amparados: 1% del valor del reclamo con un mínimo de USD. 200.- por
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                                    <td style="width:98%;">Para la cobertura de vidrios USD. 20.- por evento y/o reclamo demás
                                        coberturas:</td>
                                </tr>
                                <tr>
                                    <td style="width:2%;" valign="top">-</td>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                <tr>
                                    <td style="width:100%;" valign="top">
                                        ...
                                        <br>La Compañía debe pronunciarse sobre el derecho del asegurado dentro de los treinta días de recibidas la información y evidencia. Se dejará constancia escrita de la fecha de recepción de la información y evidencias a afecto del cómputo del plazo.<br />
                        ...
                        <td colspan="2">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: auto; margin-top:4px;">
                                ...
                                <tr>
                                    ...
                                    <td style="width:54%;" align="right" style="font-size:6pt;">&nbsp;“Impreso el {{date("d/m/Y")}}. El presente certificado reemplaza cualquier otro certificado impreso en fechas anteriores a la indicada.”</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
