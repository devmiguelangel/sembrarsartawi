            ...
            {!! Form::open(['route' => ['de.detail.balance.update', 'rp_id' => $rp_id, 'header_id' => encode($header->id), 'detail_id' => encode($detail->id)],
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        ...
                        <label id="location-error" class="validation-error-label" for="location" ng-show="errors.amount_requested">@{{ errors.amount_requested[0] }}</label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        ...
                        <label id="location-error" class="validation-error-label" for="location" ng-show="errors.balance">@{{ errors.balance[0] }}</label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-right">
                    <script ng-if="success.beneficiary">
                        $(function(){messageAction('succes', 'El Saldo Deudor fue actualizado correctamente');});
                    </script>
