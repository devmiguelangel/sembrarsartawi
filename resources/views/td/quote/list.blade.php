        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat border-top-primary">
                ...
                <div class="panel-body">
                    <div class="col-xs-12">
                        {!! Form::open(['route' => ['td.issue.lists', 'rp_id' => $rp_id], 'method' => 'get', 'class' => 'form-horizontal']) !!}
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            ...
                                                            @else
                                                                <a href="{{ route('td.result_cot', ['rp_id' => $rp_id, 'header_id' => encode($header->id)]) }}">
                                                        ...
                                                        <li>
                                                            <a href="#"
                                                               onclick="cargaModal({{ $header->id }},'{{ Session::token() }}', '{{ encode($header->id) . '/slip' }}', 'POST', 'cotizacion')"
