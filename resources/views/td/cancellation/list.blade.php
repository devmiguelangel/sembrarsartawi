        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i>
                    <span class="text-semibold">Anulación de Pólizas</span></h4>
            </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat border-top-primary">
                ...
                <div class="panel-body">
                    <div class="col-xs-12">
                        {!! Form::open(['route' => ['td.cancel.lists', 'rp_id' => $rp_id], 'method' => 'get', 'class' => 'form-horizontal']) !!}
                                            ...
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            <a href="{{ route('td.cancel.create', ['rp_id' => $rp_id, 'header_id' => encode($header->id)]) }}"
