                    ...
                    @endif
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="text-right">
                                @if($flag == 1) 
                                <a href="{{ route('report.auto_report_general') }}" class="btn btn-default" title="Cancelar">Cancelar <i class="icon-cross2 position-right"></i></a>
                                @else 
                                <a href="{{ route('report.auto_report_general_emitido') }}" class="btn btn-default" title="Cancelar">Cancelar <i class="icon-cross2 position-right"></i></a>
                                @endif 
                                            ...
                                            <ul class="icons-list">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            @if($flag == 2)
                                                            <li>
                                                                <a href="#" onclick="cargaModal({{ $entities->id }},'{{ Session::token() }}', 'slip_rep_au_cot', 'POST', 'cotizacion',1)" data-toggle="modal" data-target="#modal_general">
                                                                    <i class="icon-plus2"></i> Ver Slip de Cotización
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" onclick="cargaModal({{ $entities->id }},'{{ Session::token() }}', 'slip_rep_au_emision', 'POST', 'emision',1)" data-toggle="modal" data-target="#modal_general">
                                                            ...
                                                            <li>
                                                                <a href="#" onclick="cargaModal({{ $entities->id }},'{{ Session::token() }}', 'slip_rep_au_general', 'POST', 'emision',1)" data-toggle="modal" data-target="#modal_general">
                                                                    <i class="icon-plus2"></i> Ver Certificado de Desgravamen
                                                                </a>
                                                            </li>
                                                            @endif
