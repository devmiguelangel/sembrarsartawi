...
{!! Form::open(['route' => ['au.fa.request.store',  'rp_id' => $rp_id, 'header_id' => encode($header->id)],
  'method'        => 'put',
...
<label id="location-error" class="validation-error-label" for="location"
       ng-show="errors.facultative_observation">@{{ errors.facultative_observation[0] }}</label>
...
<div class="text-right">
    ...
    {!! Form::button('Enviar Solicitud <i class="icon-floppy-disk position-right" ng-click="$event.stopPropagation(); $event.preventDefault()"></i>', [
        'type'  => 'submit',
