...
$(document).ready(function(){
    /*------------------------AJAX ACTIVAR DESACTIVAR USUARIOS--------------------*/
    $('a[href].confirm_active_user').click(function(e){
        e.preventDefault();
        var href = $(this).prop('href');
        var _id = $(this).prop('id');
        var arr = _id.split("|");
        //alert(_id+'  href= '+href);
        bootbox.confirm("Esta seguro de dar "+arr[0]+" al usuario "+arr[1]+"?", function(result) {
            if(result){
                //alert('ingreso');
    ...
    /*----------------------AJAX ACTIVAR DESACTIVAR AGENCIAS---------------*/
    $('a[href].confirm_active_agency').click(function(e){
        e.preventDefault();
        var href = $(this).prop('href');
        var text = $(this).prop('id');
        //alert(text+'  href= '+href);
        bootbox.confirm("Esta seguro de "+text+" la agencia ?", function(result) {
            if(result){
                $.get( href, function( data ) {
                    console.log(data);
                    if(data==1){
    ...
    /*----------------------AJAX ACTIVAR DESACTIVAR EMAILS-----------------*/
    $('a[href].confirm_active_email').click(function(e){
        e.preventDefault();
        var href = $(this).prop('href');
        var text = $(this).prop('id');
        //alert(text+'  href= '+href);
        bootbox.confirm("Esta seguro de "+text+" el correo electronico ?", function(result) {
            if(result){
                $.get( href, function( data ) {
                    console.log(data);
                    if(data==1){
    ...
    /*---------------------AJAX VENTANA MODAL SLIP/EMISION---------------------*/
    $('a[href].open_modal').click(function(e){
        ...
        if(id=='slip'){
            ...
            $('.main-title').text('Ver Certificado Vida Grupo');
        }
    ...
    /*--------------------AJAX VENTANA MODAL LIST OCCUPATION-------------------*/
    $('a[href].open_modal_list').click(function(e){
        e.preventDefault();
        ...
        //alert(rel);
        //alert('href: '+href+'  id: '+id);
        if(id=='list'){
            $('.main-title').text('Lista de Ocupaciones '+product);
        }
