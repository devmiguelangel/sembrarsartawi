jQuery(document).ready(function () {
            ...
            $(':password#contrasenia').pwstrength(options);
        });
...
(function ($) {
    ...
    var options = {
            ...
            minChar: 8,
            errorMessages: {
                password_to_short: "Máximo 14 caracteres mínimo 8 caracteres",
                same_as_username: "Your password cannot be the same as your username"
            },
            scores: [17, 26, 40, 50],
            verdicts: ["Demasiado Corta", "Muy Debil", "Debil", "Bueno", "Fuerte"],
            showVerdicts: true,
            raisePower: 1.4,
