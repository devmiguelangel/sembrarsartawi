...
class MedicalCertificateController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            if ($this->facultativeRepository->getFacultativeById(decode($id)) && $this->repository->getMedicalCertificateByProduct(decode($rp_id))) {
    ...
    {
        if ($request->ajax()) {
            if ($this->facultativeRepository->getFacultativeById(decode($id)) && $this->repository->storeMedicalCertificate($request)) {
