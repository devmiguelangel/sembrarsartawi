...
class UserAdminRepository extends BaseRepository{
    ...
    public function listUser()
    {
        $this->model = User::join('ad_user_types', 'ad_users.ad_user_type_id', '=', 'ad_user_types.id')
                            ...
                            ->select('ad_users.id as id_user', 'ad_user_types.name as type', 'ad_users.username', 'ad_users.full_name', 'ad_users.email', 'ad_cities.name as cities', 'ad_agencies.name as agencies', 'ad_users.active', 'ap.name as profile', 'aup.active as active_profile')
                            ->get();
